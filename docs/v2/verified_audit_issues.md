...
| 2 | Confirmed | The package placed `unittest.main()` before later classes at historical `tests/test_canonical_values.py:294`. It is now the final executable statement at `tests/test_canonical_values.py:424`. | Fixed and verified by equal direct/pytest counts. |
