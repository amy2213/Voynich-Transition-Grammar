...
|---|---|---|---|
| Shared methods | `scripts/_canonical.py` | Parsing, classification, ambiguity, sequence boundaries, transitions, clustering, block sampling | Canonical for Phase 1 |
...
| Provisional analyses | `scripts/02_*.py` through `scripts/20_*.py` | Historical, exploratory, narrowed, or awaiting shared-method migration | Not canonical unless ledger says otherwise |
