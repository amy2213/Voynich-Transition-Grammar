...
and compare the manuscript's structural profile against $16$ natural-language comparators across $9$ language families and a shuffled-token control. Five findings
...
\begin{enumerate}
  ...
  \item \textbf{Bidirectional self-clustering symmetry.} $P/S = 0.99$ with
        both prefix and suffix SC $> 1.5\times$. Unique among $18$ tested
        systems.
...
broad classes and the comparator pool to $16$ natural languages across $9$ families; other natural-language types (Sinitic,
...
\begin{enumerate}
  ...
  \item \textbf{Additional language types.} Sinitic has been tested (Mandarin,
        SYMM-LOW).
        Polysynthetic languages (Nahuatl --- unavailable at corpus scale
        from Leipzig) and historical shorthand systems (Tironian notae)
        remain untested. Georgian, Tagalog, and Mandarin have been tested
        and all fall in SYMM-LOW.
\end{enumerate}
